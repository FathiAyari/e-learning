...
class AuthService {
  ...
  Future registerUser(String email, String password , String nomPrenom )   async {
    try {
       EndUser endUser = EndUser( //houni nbadel chnowa nheb bch na3mel create
                              nomPrenom: nomPrenom,
                              email: email,
      ...
      User firebaseUser = endUserCredentials.user!;
    await    createUserDocument(_firebaseAuth.currentUser!.uid,endUser);
      return _userFirebaseUser(firebaseUser);
    } catch (e) {
...
//lcrud ta3 read lel course w jduda bl stream
