...
class _CursePageState extends State<CoursePage> {
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: AssetImage(
                                'assets/images/$chosenImg.png')), //BCH TASWIRA KOL MARRA T3AYET SELON L HAJA LI KTEBTHA
                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      //hedhom l cour najem nbadel asamihom chnowa ena nheb nhot
                      productListing("Introduction",
                          "Introduction of the course", "active"),
                      productListing("Language of Color",
                          "learn about the longauge of...", "inactive"),
                      productListing("Psychologie of color",
                          "learn about the Psychologie ", "inactive"),
                      productListing("Introduction",
                          "Introduction of the course", "active"),
                      productListing("Introduction",
                          "Introduction of the course", "active"),
  ...
  Column productListing(
      ...
      String info,
      String
          activeOrInactive) //l cour l wehd fihom hedhom n3aytelhom louta bel kol mba3ed nbadel chnowa nheb
  {
    ...
    return Column(
      children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: (activeOrInactive == 'active')
                    ? Color(0xff2657ce)
                    : Color(0xffd3defa), //wki tabda l 3ax bidha
        ...
        Center(
          child: Container(
            margin:
                EdgeInsets.symmetric(vertical: 10), //bch yeb3ou les 3la b3adhom
